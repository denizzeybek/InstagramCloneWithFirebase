...
public class FeedActivity extends AppCompatActivity {
    ListView listView;
    ArrayList<String> usernamesFromParse;// post class dan çekeceğim görüntü arraylistleri
                ...
                if(e!=null){
                    ...
                    if (objects.size() >0){
                        for (final ParseObject object : objects){
                            //image file olarak database de kaydedildiği için önce file ı download edicem
                            ...
                            parseFile.getDataInBackground(new GetDataCallback() {
                                ...
                                public void done(byte[] data, ParseException e) {
                                    if(e==null && data !=null){
                                        ...
                                        postClass.notifyDataSetChanged(); // postclass ı bağlamış oldum
                                    }
